<div align="center">
  <br />
    <a href="#" target="_blank">
      <img src="./moodflix_screen.png" alt="Project Banner">
    </a>
  <br />
  ...
  <h3 align="center">MoodFlix</h3>

   <div align="center">
     Moodflix is a movie search application, where users can browse, search and see trending movies.
    </div>
</div>
...
```bash
git clone https://github.com/Damjan15/moodflix.git
cd moodflix
```
